...
import com.example.My_first_project.quiz.Quiz
...
class QuezFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val quiz = QuizStorage.getQuiz(
            when
                    (getString(R.string.locale_language).toInt()) {
                LOCAL_EN -> QuizStorage.Locale.En
                LOCAL_RU -> QuizStorage.Locale.Ru
                else -> null
            }!!
        )
        ...
        binding.btnStart.setOnClickListener {
            ...
            if (checkAnswers[0] == -1 ||
                ...
                Snackbar.make(it, getString(R.string.error_take_answers), Snackbar.LENGTH_SHORT).show()
            } else {
    ...
    companion object {
        const val LOCAL_EN = 0
        const val LOCAL_RU = 1
